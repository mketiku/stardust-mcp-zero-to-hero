...
class StardustOperationsServerTest {
    ...
    @Test
    fun `getPersonnelDeployment returns success for found officer and bay`() = runTest {
        // Given
        val pid = "PID-TEST"
    ...
    @Test
    fun `getPersonnelDeployment returns message for missing officer`() = runTest {
        // Given
        val pid = "PID-MISSING"
    ...
    @Test
    fun `getPersonnelDeployment returns message for missing bay specs`() = runTest {
        // Given
        val pid = "PID-TEST"
